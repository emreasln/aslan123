            ...
            <div class="row">
                <div class="col-xl-6 col-md-12" data-aos="zoom-in" data-aos-duration="800">
                    <div class="banner-top__content">
                        ...
                        <h2 class="title">𝐓𝐡𝐞 𝐏𝐨𝐰𝐞𝐫 𝐎𝐟 𝐁𝐑𝐂-20 𝐓𝐨𝐤𝐞𝐧𝐬: 𝐀 𝐒𝐭𝐞𝐩 𝐈𝐧𝐭𝐨 𝐓𝐡𝐞 𝐅𝐮𝐭𝐮𝐫𝐞 𝐎𝐟 𝐖𝐞𝐛3</h2>
                        <p class="desc">SatStarter - the pioneer LaunchPad & incubator built on Ordinals & BRC-20.</p>

                        <div class="button">
                            <router-link class="btn-action style-3" to="/connect-wallet"><span>CLICK TO JOIN IDO</span><span class="icon-arrow"></span></router-link>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-12" data-aos="fade-up" data-aos-duration="800">
                    <div class="banner-top__sale">
                        <div class="sale-content">
                            <h3>TOKEN SALE</h3>
                            <Countdown 
                                starttime="Jul 15, 2023 15:37:25" 
                                endtime="AUG 1, 2023 16:37:25" >
                            </Countdown>
                        
                            <div class="token-bar">
                                <div class="top">
                                    <h6>Raised - <span>0 Tokens</span></h6>
                                    <h6>Target - <span>200,000 Tokens</span></h6>
                                </div>
                                <div class="main">
